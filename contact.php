...
<head>
   <meta charset="utf-8">
   <title>société de plomberie à casablanca|NSS PLOMBERIE</title>
...
<body>
         ...
         <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="mt-4 mt-lg-0 me-lg-n4 py-3 px-4 bg-primary d-flex align-items-center">
               ...
               <div class="ms-3">
                  ...
                  <a href="tel:0639372790">
                     <h5 class="m-0 text-white">(+212) 06 39 37 27 90</h5>
                  </a>
               </div>
            </div>
         </div>
   ...
   <div class="container-xxl py-5">
      ...
      ?>
               <h6 class="text-success text-uppercase">Entrer en contact</h6>
               <h1 class="mb-4">Contact pour toute question</h1>
               <p class="mb-4">Nous intervenons dans les plus brefs délais et mettons à votre service une équipe de plombiers capables de répondre à tous vos besoins.. <a href="https://plomberie-casablanca-maroc.com"></a>.societe de Plomberie Casablanca</p>
                  ...
                  if (isset($_POST['sendEmailSubBtn'])) {
                     ...
                     if (
                        ...
                        if (mysqli_query($conn, $sqls)) {
                           ...
                           $subject = 'DEMANDE DE CONTACT NSS PLOMBERIE';
